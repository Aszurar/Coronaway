...
export const SignUpUser = ({ setScreen, userType }: SignUpUserProps): JSX.Element => {
	return (
		<Container>
			...
			<InputContainer>
				...
				{userType === 'establishment' && <Input name="street-address" icon="map-pin" placeholder="Endereço" />}
